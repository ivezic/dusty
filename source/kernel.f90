...
!=======================================================================
  ...
  do while (istop.eq.0)
     ...
     call Solve(model,initial,nG,error,delta,iterfbol,fbolOK)
...
!***********************************************************************
subroutine Solve(model,initial,nG,error,delta,iterfbol,fbolOK)
!=======================================================================
...
10 do while(fbolOK.eq.0)
     ...
     call SetGrids(pstar,iPstar,error,initial,iterfbol)
...
!***********************************************************************
subroutine SetGrids(pstar,iPstar,error,initial,iterfbol)
!=======================================================================
...
!=======================================================================
  ...
  if (maxrat.gt.accuracy) then 
     do iY = 2, nY
       if  ((dabs(Td(1,iY-1)/Td(1,iY)).gt.(1.+accuracy)**(0.25))) then
